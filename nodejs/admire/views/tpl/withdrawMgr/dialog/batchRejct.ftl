<script type="text/ng-template" id="batchReject.ftl">
	<div id="batch-content"  style="font-size:12px;">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			<h4 class="modal-title" id="errorModalLabel">批量拒绝</h4>
		</div>
		...
		<div class="modal-footer">
			<button type="button" class="btn btn-primary"     ng-class="{true: 'active', false: 'disabled'}[isActive]"  ng-click="rejectAction('ConfirmRejeCtrl')"  >确认拒绝</button>
